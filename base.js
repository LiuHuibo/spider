...
(function(z) {
    ...
    var Da = function(a) {
        if (z.t.execScript) z.t.execScript(a, "JavaScript");
            ...
            if (null == Ea)
                if (z.t.eval("var _evalTest_ \x3d 1;"), "undefined" != typeof z.t._evalTest_) {
                    try {
    ...
    z.rb = function(a, b, c) {
        for (var d = a.length, f = z.pa(a) ? a.split("") : a, g = 0; g < d; g++)
    ...
    var oc = function(a, b, c, d) {
        if (c == ic && b.jm && !b.always)
            for (; a && a.ss; a = a.Ra) a.ss = !1;
        if (b.ij) b.ij.Ra = null, vc(b, c, d);
        else try {
    ...
    z.md = function(a, b, c, d, f) {
        if (z.na(b))
            for (var g = 0; g < b.length; g++) z.md(a, b[g], c, d, f);
        else c = z.cd(c), z.Vc(a) ? a.qa(b, c, d, f) : a && (a = z.ed(a)) && (b = a.bo(b, c, !!d, f)) && z.nd(b)
    };
    z.nd = function(a) {
        ...
        id--;
        (c = z.ed(b)) ? (ad(c, a), 0 == c.rq && (c.src = null, b[fd] = null)) : Zc(a);
        return !0
    };
    var hd = function(a) {
    ...
    var Ad = function(a, b, c, d, f, g) {
        if (z.na(c))
            for (var h = 0; h < c.length; h++) Ad(a, b, c[h], d, f, g);
        else {
    ...
    var Kd = function(a, b, c) {
        if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);
            ...
            for (var d = z.Jd(a), f = z.Id(a), g = f.length, h = 0; h < g; h++) b.call(c, f[h], d && d[h], a)
    };
    z.Ld = function() {};
    z.Nd = function(a) {
    ...
    var Xd = function(a) {
        var b;
        (b = a.MD) || (b = {}, Yd(a) && (b[0] = !0, b[1] = !0), b = a.MD = b);
        return b
    };
    var Zd = function() {};
    var $d = function(a) {
    ...
    var Yd = function(a) {
        if (!a.CG && "undefined" == typeof window.XMLHttpRequest && "undefined" != typeof window.ActiveXObject) {
            for (var b = ["MSXML2.XMLHTTP.6.0", "MSXML2.XMLHTTP.3.0", "MSXML2.XMLHTTP", "Microsoft.XMLHTTP"], c = 0; c < b.length; c++) {
                var d = b[c];
                try {
                    return new window.ActiveXObject(d), a.CG = d
                } catch (f) {}
            }
    ...
    z.be = function(a, b) {
        ...
        a: {
            ...
            for (var f = b.length; 0 <= (d = a.indexOf(b, d)) && d < c;) {
                ...
                if (38 == g || 63 == g)
                    if (g = a.charCodeAt(d + f), !g || 61 == g || 38 == g || 35 == g) break a;
                d += f + 1
            }
            d = -1
        }
    ...
    var ie = function(a) {
        if (a.Nh && "undefined" != typeof z.je && (!a.mv[1] || 4 != ke(a) || 2 != le(a)))
            if (a.Ps && 4 == ke(a)) z.vd(a.BI, 0, a);
            else if (a.dispatchEvent("readystatechange"), a.Je()) {
            a.Nh = !1;
            try {
                if (ne(a)) a.dispatchEvent("complete"), a.dispatchEvent("success");
                else {
                    var b;
                    try {
    ...
    var ne = function(a) {
        ...
        if (!c) {
            if (b = 0 === b) a = String(a.zz).match(z.re)[1] || null, !a && z.t.self && z.t.self.location && (a = z.t.self.location.protocol, a = a.substr(0, a.length - 1)), b = !se.test(a ? a.toLowerCase() : "");
            c = b
        }
        return c
    };
    ...
    var xe = function(a) {
        ...
        for (var b = a.th, d = c = !1; a.Cu.length && !a.qw;) {
            ...
            if (g = a.fo ? h : g) try {
                ...
                if (Ga(b) || "function" === typeof z.t.Promise && b instanceof z.t.Promise) d = !0, a.qw = !0
            } catch (m) {
                b = m, a.fo = !0, Ae(a) || (c = !0)
            }
        }
        a.th = b;
        d && (k = (0, z.q)(a.nE, a, !0), d = (0, z.q)(a.nE, a, !1), b instanceof ve ? (ze(b, k, d), b.lN = !0) : b.then(k, d));
    ...
    var Ve = function(a, b, c, d) {
        ...
        for (; d < c.length; d++) {
            var g = c[d];
            !z.oa(g) || z.ta(g) && 0 < g.nodeType ? f(g) : z.y(We(g) ? z.vb(g) : g, f)
        }
    };
    z.Xe = function(a) {
    ...
    z.ff = function(a) {
        return gf && void 0 != a.children ? a.children : z.mb(a.childNodes, function(a) {
            return 1 == a.nodeType
        })
    };
    z.hf = function(a) {
    ...
    z.nf = function(a, b) {
        if ("textContent" in a) a.textContent = b;
            ...
            a.firstChild.data = b
        } else z.af(a), a.appendChild(z.Je(a).createTextNode(String(b)))
    };
    z.of = function(a, b) {
    ...
    z.rf = function(a, b, c) {
        if (!(a.nodeName in sf))
            ...
            for (a = a.firstChild; a;) z.rf(a, b, c), a = a.nextSibling
    };
    var We = function(a) {
    ...
    var Hf = function(a, b) {
        ...
        var c = a.mh[b],
            ...
            g = null;
        try {
            if (a.cK || a.Mr && (z.Jf || Rb() && 0 <= z.$a(Tb(), "36")))
                for (var h = 0; h < d.length; h++) Da(f[h] + " //@ sourceURL\x3d" + d[h]);
            else Da(f.join("\n"))
        } catch (k) {
            g = k
        }
    ...
    var ig = function(a, b) {
        for (var c = 0; c < b.length; c++)
            if (a.Zc[b[c]].vc()) throw Error("Module already loaded: " + b[c]);
        for (var d = [], c = 0; c < b.length; c++) d = d.concat(jg(a, b[c]));
        zb(d);
        return !a.ED && 1 < d.length ? (c = d.shift(), a.ud = z.nb(d, function(a) {
            return [a]
        }).concat(a.ud), [c]) : d
    };
    var jg = function(a, b) {
    ...
    var og = function(a, b) {
        1 < a.sh.length ? a.ud = z.nb(a.sh, function(a) {
            return [a]
        }).concat(a.ud) : lg(a, b)
    };
    var lg = function(a, b) {
        ...
        if (h)
            for (f = 0; f < h.length; f++)
                for (var k = h[f], g = 0; g < d.length; g++) k("error", d[g], b);
    ...
    z.Gg = function(a, b, c) {
        if (b instanceof z.He) c = b.height, b = b.width;
    ...
    z.Mg = function(a, b) {
        var c = z.J(b),
            d = null,
            f = c.ua();
        if (z.C && f.createStyleSheet) c = d = f.createStyleSheet(), z.C && z.ka(c.cssText) ? c.cssText = a : c.innerHTML = a;
        else {
    ...
    var hh = function() {
        window.wx.ready(function() {
            ih().then(function(a) {
                var b = Object.assign({}, jh, a.timeline);
                window.wx.onMenuShareTimeline(b);
                a = Object.assign({}, jh, a.appMessage);
    ...
    z.qh = function(a, b) {
        ...
        this.Fe = this.DR = !1;
        var c;
        if (a instanceof z.qh) this.Fe = z.ka(b) ? b : a.Fe, rh(this, a.Gi), c = a.oe, z.sh(this), this.oe = c, c = a.Pg, z.sh(this), this.Pg = c, th(this, a.om), c = a.Ne, z.sh(this), this.Ne = c, uh(this, a.Ce().clone()), c = a.zj, z.sh(this), this.zj = c;
            ...
            z.sh(this);
            this.zj = vh(c)
        } else this.Fe = !!b, this.le = new z.wh(null, 0, this.Fe)
    };
    ...
    var Ch = function(a) {
        a.Lb || (a.Lb = new z.Rd, a.Ka = 0, a.$d && ae(a.$d, function(b, c) {
    ...
    var li = function(a, b) {
        ...
        else if (12 > b) c = a.zb.JL[b - 8], c = c.replace("{1}", a.zb.QC[b - 8]), c = c.replace("{0}", a.zb.VC[b - 8]);
        else {
            li(a, 10);
            return
        }
    ...
    var ri = function(a, b, c, d, f, g) {
        ...
        switch (b.charAt(0)) {
            case "G":
                return c = 0 < d.getFullYear() ? 1 : 0, 4 <= h ? a.zb.LL[c] : a.zb.ML[c];
            case "y":
                return c = d.getFullYear(), 0 > c && (c = -c), 2 == h && (c %= 100), pi(a, Ya(c, h));
            case "M":
                ...
                return h;
            case "k":
                return qi(f), pi(a, Ya(f.getHours() || 24, h));
            case "S":
                return pi(a, (f.getTime() % 1E3 / 1E3).toFixed(Math.min(3, h)).substr(2) + (3 < h ? Ya(0, h - 3) :
                    ""));
            case "E":
                return c = d.getDay(), 4 <= h ? a.zb.mM[c] : a.zb.YL[c];
            case "a":
                return qi(f), h = f.getHours(), a.zb.IL[12 <= h && 24 > h ? 1 : 0];
            case "h":
                return qi(f), pi(a, Ya(f.getHours() % 12 || 12, h));
            case "K":
                return qi(f), pi(a, Ya(f.getHours() % 12, h));
            case "H":
                return qi(f), pi(a, Ya(f.getHours(), h));
            case "c":
            ...
            case "L":
                ...
                return h;
            case "Q":
                return c = Math.floor(d.getMonth() / 3), 4 > h ? a.zb.XL[c] : a.zb.RL[c];
            case "d":
                return pi(a, Ya(d.getDate(), h));
            case "m":
                return qi(f), pi(a, Ya(f.getMinutes(), h));
            case "s":
                return qi(f), pi(a, Ya(f.getSeconds(), h));
            case "v":
                return h = g || fi(c.getTimezoneOffset()), h.PB;
            case "V":
                return a = g || fi(c.getTimezoneOffset()), 2 >= h ? a.PB : 0 < hi(a, c) ? z.ka(a.Ik.KL) ? a.Ik.KL : a.Ik.DST_GENERIC_LOCATION : z.ka(a.Ik.UC) ? a.Ik.UC : a.Ik.STD_GENERIC_LOCATION;
            case "w":
                return c =
                    a.zb.SC, f = new Date(f.getFullYear(), f.getMonth(), f.getDate()), b = a.zb.RC || 0, c = f.valueOf() + 864E5 * (((z.ka(c) ? c : 3) - b + 7) % 7 - ((f.getDay() + 6) % 7 - b + 7) % 7), pi(a, Ya(Math.floor(Math.round((c - (new Date((new Date(c)).getFullYear(), 0, 1)).valueOf()) / 864E5) / 7) + 1, h));
            case "z":
                return a = g || fi(c.getTimezoneOffset()), 4 > h ? a.ZB[0 < hi(a, c) ? 2 : 0] : a.ZB[0 < hi(a, c) ? 3 : 1];
            case "Z":
                return f = g || fi(c.getTimezoneOffset()), 4 > h ? (h = -(f.Mu - hi(f, c)), a = [0 > h ? "-" : "+"], h = Math.abs(h), a.push(Ya(Math.floor(h / 60) % 100, 2), Ya(h % 60, 2)), h = a.join("")) : h = pi(a,
                    gi(f.Mu - hi(f, c))), h;
            default:
                return ""
        }
    ...
    z.wi = function(a, b) {
        ...
        if (60 > c) return c + " 鍒嗛挓鍓�";
        c = (0, window.parseInt)(c / 60);
        if (24 > c) return c + " 灏忔椂鍓�";
        var c = b.getFullYear() - a.getFullYear(),
            d = b.getMonth() - a.getMonth(),
            f = b.getDate() - a.getDate();
        return 0 === c && 0 === d ? f + " 澶╁墠" : 0 === c && 1 === d || 1 === c && -11 === d ? 0 > f ? (new Date(a.getFullYear(), a.getMonth() + 1, 0)).getDate() + f + " 澶╁墠" : "1 鏈堝墠" : 2 > c ? 1 === c && 0 <= d ? "1 骞村墠" : 12 * c + d + " 鏈堝墠" : c + " 骞村墠"
    };
    var xi = function(a, b) {
    ...
    var Gi = function() {
        (0, window.$)(window.document).on("click", "a[href]", function(a) {
            ...
            !c || c.startsWith("#") || "http:" !== b.protocol && "https:" !== b.protocol || (0, z.Hi)(b, {
                action: "OpenUrl",
    ...
    var Ii = function() {
        ...
        a && window.$.ajax({
            ...
            for ((0, z.Ji)({
                ...
                Ei.shift(), a.fn.apply(a, [].concat(ja(a.XM)));
            Li();
            Gi()
        })
    };
    ...
    z.Pi = function() {
        var a = !z.fh && !Si,
            b;
        if (b = (b = (0, window.$)('meta[name\x3d"apple-itunes-app"]').attr("content")) && b.replace(/,\s*/, "\x26")) b = new z.wh(b), a ? Qi(b.get("app-argument")) : (b.add("origin", window.location.href), window.location.href = "/openinapp_instruction?" + b.toString())
    };
    var Qi = function(a) {
        if (a)
            if (-1 === a.indexOf("zhihu://") && (a = "zhihu://" + a), Ti) Ui(a);
    ...
    z.kj = function(a, b) {
        a.classList ? a.classList.remove(b) : z.hj(a, b) && (a.className = z.mb(z.gj(a), function(a) {
            return a != b
        }).join(" "))
    };
    z.lj = function(a, b) {
        a.classList ? z.y(b, function(b) {
            z.kj(a, b)
        }) : a.className = z.mb(z.gj(a), function(a) {
            return !z.A(b, a)
        }).join(" ")
    };
    z.mj = function(a) {
    ...
    z.Tj = function(a) {
        a.Zk && a.o().g(a.Qc || a.Ac, "click", function() {
            this.Zk && this.G(!1)
        })
    };
    z.Uj = function(a, b) {
    ...
    var fk = function(a) {
        var b = [],
            c = a.Lz;
        (0, window.$)(".Captcha-mark", a.X).each(function(a, f) {
            var g = (0, window.$)(f);
    ...
    z.wk = function(a, b) {
        a && (this.input = a, "string" === typeof b && (b = {
            text: b
        }), z.Mb(this.J = {}, this.defaults, b || {}), this.Yg = null, xk(this))
    };
    var xk = function(a) {
        var b = a.input,
            c = a.J;
    ...
    var Fk = function(a) {
        a.Vs((0, window.$)(".send-code", a.h), function() {
    ...
    var Jk = function(a) {
        ...
        a.cV = a.Vs(f, function() {
            var a = c.val(),
                f, k;
            this.rf(a) ? (f = "/send_login_verification_code/email", a = {
                email: a
            }, k = "閭鏀跺埌鐨� 6 浣嶆暟楠岃瘉鐮�") : (f = "/send_login_verification_code/sms", a = {
                phone_num: a
            }, k = "鎵嬫満鏀跺埌鐨� 6 浣嶆暟楠岃瘉鐮�");
            window.$.get(f,
                a,
    ...
    var Nk = function(a) {
        ...
        a.Ge(b, a.MS);
        a.Ws(b);
        (0, window.$)("input.account", b).val(a.Bh.account);
        (0, window.$)("button.unable-login", a.rv).click(function() {
            var b = new z.Gk;
            ok(a, b)
        })
    };
    var Ok = function(a) {
        ...
        var b = {
            ...
            c = z.Ka("璇�%s鏇剧粦瀹氳繃浠ヤ笅鐭ヤ箮甯愬彿", b),
            b = z.Ka("涓嶇粦瀹氾紝鐢�%s鍒涘缓鏂板笎鍙�", b);
        (0, window.$)("h2", a.qL).text(c);
        (0, window.$)(".name", a.tv).text(a.Bh.fullname);
        (0, window.$)("img", a.tv).attr("src", a.Bh.avatar_path);
        (0, window.$)("button.register", a.tv).text(b)
    };
    var Pk = function(a) {
        a.FC = (0, window.$)(".view.registered", a.Pc);
        a.AL = (0, window.$)(".title.registered", a.Se);
        var b = z.Ka("%s 宸叉敞鍐岃嚦濡備笅甯愬彿", a.Bh.account);
        (0, window.$)("h2", a.AL).text(b);
        (0, window.$)(".name", a.FC).text(a.Bh.fullname);
        (0, window.$)("img", a.FC).attr("src", a.Bh.avatar_path)
    };
    var Qk = function(a) {
        return {
            qqconn: "qq",
    ...
    var cl = function(a, b, c) {
        a.wa && z.y(a.gb(), b, c);
        a.o().g(a, "itemcreated", function(a) {
            b.call(c, a.item)
        })
    };
    var dl = function(a) {
    ...
    var ol = function(a, b) {
        var c;
        if (z.pa(b[a])) c = z.nb(pl(b[a]), function(a) {
    ...
    z.xc.prototype.D = function() {
        if (this.mk)
            for (; this.mk.length;) this.mk.shift()()
    };
    var Ic, Nl;
    z.vg = Pb();
    z.C = Qb();
    ...
    z.e.hasListener = function(a, b) {
        ...
        return z.Fb(this.ic, function(a) {
            for (var h = 0; h < a.length; ++h)
                if (!(c && a[h].type != d || f && a[h].gl != b)) return !0;
            return !1
        })
    };
    ...
    z.e.dispatchEvent = function(a) {
        ...
        var f = !0,
            g;
        if (b)
            for (var h = b.length - 1; !a.uk && 0 <= h; h--) g = a.currentTarget = b[h], f = z.sd(g, d, !0, a) && f;
        a.uk || (g = a.currentTarget = c, f = z.sd(g, d, !0, a) && f, a.uk || (f = z.sd(g, d, !1, a) && f));
        if (b)
            for (h = 0; !a.uk && h < b.length; h++) g = a.currentTarget = b[h], f = z.sd(g, d, !1, a) && f;
        return f
    };
    z.e.D = function() {
        z.G.v.D.call(this);
    ...
    z.e.qa = function(a, b, c, d, f) {
        if (z.na(b))
            for (var g = 0; g < b.length; g++) this.qa(a, b[g], c, d, f);
        else c = c || this.handleEvent, f = f || this.ga || this, c = z.cd(c), d = !!d, b = z.Vc(a) ? a.bo(b, c, d, f) : a ? (a = z.ed(a)) ? a.bo(b, c, d, f) : null : null, b && (z.nd(b), delete this.Za[b.key]);
        return this
    };
    ...
    z.Sl = /\uffff/.test("锟�") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g;
    ...
    z.e.send = function(a, b, c, d) {
        ...
        try {
            this.Oy = !0,
                this.ea.open(b, String(a), !0), this.Oy = !1
        } catch (g) {
            this.Xr(5, g);
            return
        }
        ...
        !z.A(Ul, b) || d || c || f.set("Content-Type", "application/x-www-form-urlencoded;charset\x3dutf-8");
        ...
        try {
            qe(this), 0 < this.Wu && ((this.kC = fe(this.ea)) ?
                (this.ea.timeout = this.Wu, this.ea.ontimeout = (0, z.q)(this.iq, this)) : this.Vu = z.vd(this.iq, this.Wu, this)), this.Ps = !0, this.ea.send(a), this.Ps = !1
        } catch (g) {
            this.Xr(5, g)
        }
    };
    ...
    */
    ...
    var Ue, gf, qf;
    Ue = !z.C || 9 <= z.Ug;
    gf = !z.B && !z.C || z.C && 9 <= z.Ug || z.B && z.E("1.9.1");
    qf = z.C && !z.E("9");
    z.Vl = z.C && !(9 <= z.Ug);
    z.e = z.Ge.prototype;
    z.e.clone = function() {
    ...
    z.Vi = z.Ec() || z.Ab("iPod");
    z.Wj = z.Ab("iPad");
    z.Xl = z.Ab("Android") && !(Sb() || Rb() || Pb() || z.Ab("Silk"));
    z.Jf = Sb();
    z.Yl = z.Ab("Safari") && !(Sb() || z.Ab("Coast") || Pb() || z.Ab("Edge") || z.Ab("Silk") || z.Ab("Android")) && !(z.Ec() || z.Ab("iPad") || z.Ab("iPod"));
    z.x(Gf, z.G);
    z.e = Gf.prototype;
    z.e.Mr = !1;
    z.e.cK = !1;
    z.e.$R = function(a, b, c, d) {
        ...
        if (this.mh[a]) null != f.UA && Hf(this, a);
            ...
            this.mh[a] = f;
            c = [];
            for (d = 0; d < a.length; d++) z.wb(c, b[a[d]].Jk);
            !this.Mr || this.cK || this.Mr && (z.Jf || Rb() && 0 <= z.$a(Tb(), "36")) ? (this.mh[a].uJ = c, b = new ue(c), c = this.T, c.g(b, "success", (0, z.q)(this.yy, this, b, a)), c.g(b, "error", (0, z.q)(this.qy, this, b, a)), b.load()) : xf(c)
        }
    };
    z.e.yy = function(a, b) {
        var c = this.mh[b];
    ...
    z.Sf.prototype.toString = function() {
        ...
        if (0 != this.qA.lb()) {
            ...
            z.Pd(this.qA, function(b) {
                a.push("  ", b, " (", g - b.startTime, " ms, started at ", Xf(b.startTime), ")\n")
            })
        }
        b = this.Ck.ld();
        for (d = 0; d < b.length; d++) c = this.Ck.get(b[d]), 1 < c.count && a.push(" TOTAL ", c, "\n");
    ...
    z.e.cA = function(a) {
        (a = bg(this.dA, a)) && window.setTimeout(jb("Module errback failures: " + a), 0);
        this.YE.length = 0;
        this.lA.length = 0
    };
    z.e.D = function() {
    ...
    $l.Mr = !1;
    Zl.Gz = $l;
    var am = z.t.PLOVR_MODULE_INFO,
        bm;
    for (bm in am) Zl.Zc[bm] = new $f(am[bm], bm);
    Zl.Bo.hi || Zl.Bo.Vh();
    Zl.CE == Zl.nr && (Zl.CE = null, Zl.nr.mp((0, z.q)(Zl.OF, Zl)) && lg(Zl, mg), dg(Zl));
    var cm = z.t.PLOVR_MODULE_URIS,
        dm;
    for (dm in cm) Zl.Zc[dm].Jk = cm[dm];
    z.kg("base");
    (function() {
        function a(b, c) {
    ...
    var ug, Sg;
    ug = {};
    z.em = z.B ? "MozUserSelect" : z.D || z.Gc ? "WebkitUserSelect" : null;
    Sg = {
        thin: 2,
        medium: 4,
        thick: 6
    ...
    z.e.Uk = function(a, b, c) {
        ...
        this.Xe && this.Rc || (this.Xe = {}, this.Rc = []);
        if (a.getParent() == this) {
            var d = a.fe();
            this.Xe[d] = a;
            z.tb(this.Rc, a)
    ...
    z.hm = {};
    z.sm = {};
    z.tm = z.ob((0, window.$)("script.json-inline"), function(a, b) {
    ...
    var Ti, Si, ck;
    z.um = /iPad|iPhone/.test(window.navigator.userAgent);
    z.vm = z.sm.AR;
    Ti = /Android/.test(window.navigator.userAgent);
    z.wm = z.sm.Ab;
    z.fh = /MicroMessenger/.test(window.navigator.userAgent);
    Si = /Weibo/.test(window.navigator.userAgent);
    z.xm = /UCBrowser/.test(window.navigator.userAgent);
    ck = /Mobile/.test(window.navigator.userAgent) && /CriOS/.test(window.navigator.userAgent);
    z.ym = z.um && !!window.indexedDB;
    var jh = {
        title: window.document.title,
        desc: "涓庝笘鐣屽垎浜綘鐨勭煡璇嗐€佺粡楠屽拰瑙佽В",
    ...
    z.e.toString = function() {
        ...
        b && a.push(xh(b, zm, !0), ":");
        var c = this.Pg;
        if (c || "file" == b) a.push("//"), (b = this.oe) && a.push(xh(b, zm, !0), "@"), a.push((0, window.encodeURIComponent)(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.om, null != c && a.push(":", String(c));
        if (c = this.Ne) this.Pg && "/" != c.charAt(0) && a.push("/"), a.push(xh(c, "/" == c.charAt(0) ? Am : Bm, !0));
        (c = this.le.toString()) && a.push("?", c);
        (c = this.zj) && a.push("#", xh(c, Cm));
        return a.join("")
    };
    ...
    z.e.ld = function() {
        Ch(this);
        for (var a = this.Lb.Wc(), b = this.Lb.ld(), c = [], d = 0; d < b.length; d++)
    ...
    z.e.toString = function() {
        ...
        if (!this.Lb) return "";
        for (var a = [], b = this.Lb.ld(), c = 0; c < b.length; c++)
            for (var d = b[c], f = (0, window.encodeURIComponent)(String(d)), d = this.Wc(d), g = 0; g < d.length; g++) {
                var h = f;
    ...
    z.e.$l = function() {
        if (!this.Oc) return !1;
        try {
            return this.Oc.setItem("__sak", "1"), this.Oc.removeItem("__sak"), !0
        } catch (a) {
            return !1
        }
    };
    ...
    var ti = /^(\d{4})(?:(?:-?(\d{2})(?:-?(\d{2}))?)|(?:-?(\d{3}))|(?:-?W(\d{2})(?:-?([1-7]))?))?$/,
        vi = /^(\d{2})(?::?(\d{2})(?::?(\d{2})(\.\d+)?)?)?$/,
        ui = /Z|(?:([-+])(\d{2})(?::?(\d{2}))?)$/;
    ...
    var ni = !1;
    z.v("ZH.date.parse", si);
    z.v("ZH.date.fromNow", z.wi);
    z.v("ZH.date.format", xi);
    var Mi = {};
    ...
    Mi.yV = function() {
        ...
        a.push(["_addIgnoredOrganic", "鐭ヤ箮"]);
        a.push(["_addIgnoredOrganic", "鐭ヤ箮缃�"]);
    ...
    var Ki, Ei, Li;
    Ki = "www4.zhihu.com" === window.location.hostname ? "https://ws01.aws.dev/logs/batch" : "https://zhihu-web-analytics.zhihu.com/logs/batch";
    Ei = [];
    Li = Di(function(a, b) {
    ...
    z.Hm = Di(function(a, b, c) {
        a = Fi(a);
        var d = a.module;
        window.zap.trackCardShow(Object.assign({}, b, {
            path: a.path
        }), Object.assign({}, c, {
            module: d
        }))
    ...
    z.Hi = Di(function(a, b, c) {
        a = Fi(a);
        var d = a.module;
        window.zap.trackEvent(Object.assign({}, b, {
            path: a.path
        }), Object.assign({}, c, {
            module: d
        }))
    ...
    z.U.mn = function() {
        ...
        z.F(z.Y, "ga_click_top_nav_noti_tab", function(a) {
            z.U("notification", "click_top_nav_noti_tab", ["top_nav_noti_tab_message", "top_nav_noti_tab_follower", "top_nav_noti_tab_vote"][a.data.tab])
        });
        ...
        z.F(z.Y, "ga_click_sign_in_link_account", function(a) {
            a.target ? (a = (0, window.$)(a.target), z.Va(a.parent().text(), "璇ラ偖绠卞凡娉ㄥ唽") ? z.U("sign_in", "click_sign_in_link_account", "sign_up_error_user_exists_link_account") : z.Va(a.parent().text(), "濡傛灉浣犲凡鏈夌煡涔庡笎鍙�") ? (0, window.$)(".view-warmup").is(":visible") ? z.U("sign_in", "click_sign_in_link_account", "sign_in_box_splash_link_account") : (0, window.$)(".view-info").is(":visible") && z.U("sign_in", "click_sign_in_link_account", "sign_in_box_sign_up_link_account") : z.Va(a.text(), "杩斿洖娉ㄥ唽") &&
    ...
    var ej;
    z.x(z.pj, z.G);
    var Im = z.t.document && z.t.document.documentElement && !!z.t.document.documentElement.setCapture;
    z.e = z.pj.prototype;
    z.e.Qg = z.aa(18);
    z.e.o = function() {
        return this.T
    ...
    z.e.Km = function(a) {
        ...
        if (!this.ec || this.pj || b && !z.Tc(a)) this.dispatchEvent("earlycancel");
            ...
            if (0 == this.Ey)
                if (this.dispatchEvent(new vj("start", this, a.clientX, a.clientY, a))) this.pj = !0, this.aJ && a.preventDefault();
                else return;
    ...
    z.e.eQ = function(a) {
        if (this.ec) {
            ...
            if (!this.pj) {
                ...
                if (d * d + f * f > this.Ey)
                    if (this.dispatchEvent(new vj("start", this, a.clientX, a.clientY, a))) this.pj = !0;
                    else {
                        this.Fd || this.Wr(a);
                        return
                    }
    ...
    z.x(vj, z.Lc);
    var Jm = z.C ? 'javascript:""' : "about:blank";
    z.x(z.wj, z.G);
    z.wj.prototype.handleEvent = function(a) {
        var b = new z.Pc(a.gc);
    ...
    z.e.ha = function() {
        ...
        else c = z.wf(this.K()), a = c.x, c = c.y;
        var d = z.Ig(this.m()),
            b = z.Pe(b),
    ...
    var pk, Nm, Om, Pm, Qm, Rm, Sm, Km, Tm, Qj;
    z.x(z.Cj, yj);
    z.e = z.Cj.prototype;
    z.e.jF = !0;
    z.e.Dy = !0;
    ...
    z.e.Z = function(a) {
        ...
        var b = this.Sc + "-title",
            ...
            d = this.Sc + "-title-close";
        (this.zd = z.Le(null, b, a)[0]) ? (this.dd = z.Le(null, c, this.zd)[0], this.yd = z.Le(null, d, this.zd)[0]) : (this.zd = this.K().B("DIV", b), a.insertBefore(this.zd, this.Ye));
        ...
        z.Q(this.yd, this.Dy);
        b = this.Sc + "-buttons";
        (this.oc = z.Le(null, b, a)[0]) ? (this.pc = new z.Pj(this.K()), this.pc.w(this.oc)) : (this.oc = this.K().B("DIV", b), a.appendChild(this.oc), this.pc && (a = this.pc, a.h = this.oc, a.render()), z.Q(this.oc, !!this.pc));
        Hj(this, this.kr)
    };
    z.e.C = function() {
        z.Cj.v.C.call(this);
    ...
    z.e.w = function(a) {
        if (a && 1 == a.nodeType) {
            ...
            for (var b = 0, c, d, f; c = a[b]; b++)
                if (d = c.name || c.id, f = z.pf(c) || c.value, d) {
                    var g = 0 == b;
    ...
    "undefined" != typeof window.document && ((new z.Pj).Bd(Qj.Cg, !0, !0), z.Dj(), (new z.Pj).Bd(Qj.Eg, !0).Bd(Qj.Mh, !1, !0), (new z.Pj).Bd(Qj.Eg).Bd(Qj.Mh, !0).Bd(Qj.Te, !1, !0), (new z.Pj).Bd(Qj.bj).Bd(Qj.cj).Bd(Qj.Te, !0, !0));
    (function() {
        var a = z.Vi || z.Wj,
    ...
    z.e.xm = z.aa(25);
    z.e.ha = function() {
        if (!this.fm || !window.Modernizr.flexbox)
            if (z.V.v.ha.call(this), !this.vF) {
    ...
    z.V.prototype.setTitle = z.V.prototype.Oa;
    z.V.prototype.setModal = z.V.prototype.Qp;
    z.V.prototype.setDisposeOnHide = z.V.prototype.Df;
    z.V.prototype.setVisible = z.V.prototype.G;
    z.V.prototype.getContentElement = z.V.prototype.S;
    z.V.prototype.getDialogElement = z.V.prototype.ii;
    z.V.prototype.listen = z.V.prototype.g;
    z.v("ZH.dialog", z.X);
    z.X.confirm = Xj(function(a, b, c, d) {
        var f = {
                buttons: {
                    yes: "纭",
                    cancel: "鍙栨秷"
    ...
    z.X.async = function(a) {
        var b = window.$.extend({}, {
            ...
            c = z.O("div", {
                ...
                innerHTML: (b.dK || "鍔犺浇涓�") + '\x3ci class\x3d"spinner-gray"\x3e\x3c/i\x3e'
            }),
            d = z.X(b);
        d.S().appendChild(c);
    ...
    z.x(z.Yj, z.G);
    z.Yj.prototype.o = function() {
        return this.of || (this.of = new z.xd(this))
    };
    z.Yj.prototype.Ug = z.aa(26);
    z.x(Zj, z.Yj);
    Zj.prototype.init = function() {
        if (this.h = z.L("zh-global-message")) this.aI = z.N("zu-global-notify-msg", this.h), this.o().g(this.h, "click", this.Qa)
    };
    ...
    z.e.fS = function(a) {
        ...
        if (7 === (0, window.$)(".Captcha-mark", this.X).length) this.Da.data("validator").showErrors({
            captcha: "鏈€澶氬彧鑳介€夋嫨 7 涓偣"
        });
        else {
            hk(this);
            var b = this.Nk.offset(),
                c = a.pageX - b.left - this.Lz;
            a = a.pageY - b.top - this.Lz;
            (0, window.$)("\x3cspan /\x3e", {
                "class": "Captcha-mark sprite-index-icon-delete"
            }).css({
                left: c,
                top: a
            }).appendTo(this.rL).mouseenter(function() {
    ...
    var Xm = (0, z.q)(window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(a) {
    ...
    z.e.B = function() {
        ...
        this.Pc = (0, window.$)(this.S());
        (0, window.$)(z.Gj(this)).addClass("z-ico-close");
    ...
    z.yk = "placeholder" in window.document.createElement("input");
    z.e = z.wk.prototype;
    z.e.defaults = {
        text: "",
        offsetParent: null,
    ...
    z.Zm = {
        ...
        Vs: function(a, b) {
            var c =
                z.uk(a, 60, function(a) {
                    return a ? "%s 绉掑悗閲嶅彂" : "閲嶅彂楠岃瘉鐮�"
        ...
        wl: function() {
            var a = this;
            z.yk || (0, window.setTimeout)(function() {
                (0, window.$)("input[placeholder]:visible", a.Pc).placeholder()
            }, 10)
        },
        Od: function() {
    ...
    z.Ym = {
        ...
        messages: {
            ...
            account: {
                required: z.Ik ? "璇峰～鍐欓偖绠�" : "璇峰～鍐欐墜鏈哄彿鎴栭偖绠�"
            },
            agreement: {
                required: "璇峰嬀閫夊苟鍚屾剰鍗忚"
            },
            phone_num: {
                required: "璇峰～鍐欐墜鏈哄彿"
            },
        ...
        showErrors: function(a, b) {
            ...
            b.length && window.$.each(b, function(a, b) {
                ...
                "璇ラ偖绠卞凡娉ㄥ唽" !== k && "璇ユ墜鏈哄彿宸叉敞鍐�" !== k || (0, window.$)('\x3cspan\x3e 路 \x3c/span\x3e\x3ca class\x3d"switch-to-login" href\x3d"javascript:;"\x3e鐩存帴鐧诲綍\x3c/a\x3e').appendTo(m);
                Xm(function() {
    ...
    z.Ca(z.Dk.prototype, z.Zm);
    (0, window.$)(function() {
        z.T.Fb() || $m().then(function(a) {
            (0, window.$)(a).appendTo("body")
        })
    });
    z.l(z.Ek, z.Dk);
    z.Ek.prototype.B = function() {
    ...
    z.Ek.prototype.submit = function() {
        var a = this,
            b = Object.assign({}, this.options.data, this.getData());
    ...
    z.e.C = function() {
        ...
        a = (0, window.$)("form",
            this.pv);
        this.Ge(a, this.vT);
        (0, window.$)('input[name\x3d"phone_num"]', a).val(this.jw);
    ...
    z.e.tT = function(a) {
        var b = this,
            c = (0, window.$)(a);
        a = c.ne();
        (0, window.$)('input[name\x3d"account"]', this.Kq).val(a.account);
        ...
        a.is_org_page = z.Ik;
        (0, window.$)('input[name\x3d"verification_code"]', this.Kq).attr("placeholder", d ? "閭鏀跺埌鐨� 6 浣嶆暟楠岃瘉鐮�" : "鎵嬫満鏀跺埌鐨� 6 浣嶆暟楠岃瘉鐮�");
        return window.$.get(f, a, function(a) {
            a.r ? 200001 === a.errcode ? (a = '鏈烘瀯甯愬彿\x3cspan\x3e 路 \x3c/span\x3e\x3ca href\x3d"/org/signin"\x3e鐐规鎵惧洖\x3c/a\x3e',
                z.Ik && (a = '鐢ㄦ埛甯愬彿\x3cspan\x3e 路 \x3c/span\x3e\x3ca href\x3d"/signin"\x3e鐐规鎵惧洖\x3c/a\x3e'), c.data("validator").showErrors({
                    account: a
    ...
    z.Lk.prototype.C = function() {
        ...
        Pk(this);
        var a = this;
        this.Pc.on("click", "button.bind-login", function() {
            rk(a, !0, a.rv, a.pL)
        ...
        return window.$.post(d, b, function(d) {
            if (d && d.r) {
                ...
                1991831 === g ? (d = new z.Ek({
                    ...
                    Ym: a.options.Ym
                }), d.Db(a), a.pq(d)) : 200001 === g ? (d = '鏈烘瀯甯愬彿\x3cspan\x3e 路 \x3c/span\x3e\x3ca href\x3d"/org/signin"\x3e鐐规鐧诲綍\x3c/a\x3e',
                    z.Ik && (d = '涓汉甯愬彿\x3cspan\x3e 路 \x3c/span\x3e\x3ca href\x3d"/signin"\x3e鐐规鐧诲綍\x3c/a\x3e'), a.showErrors({
                        account: d
    ...
    z.Ca(z.Rk.prototype, z.Zm);
    z.l(z.Sk, z.Dk);
    z.Sk.prototype.B = function() {
        z.Dk.prototype.B.call(this);
    ...
    z.Tk.prototype.start = function() {
        if (!this.Lo) {
            ...
            h.submit = [];
            this.xv.on("mousedown.recording mouseenter.recording mouseleave.recording", ":submit", function(a) {
    ...
    z.Ca(z.Uk.prototype, z.Zm);
    z.l(z.Vk, z.R);
    z.Vk.prototype.C = function() {
        z.R.prototype.C.call(this);
        this.We();
    ...
    z.Ca(z.Wk.prototype, z.Zm);
    z.x(Yk, z.G);
    var $k = {};
    Yk.prototype.defaults = {};
    Yk.prototype.o = function() {
        return this.Yg || (this.Yg = new z.xd(this))
    };
    Yk.prototype.init = function() {};
    ...
    z.e.use = function(a, b) {
        var c = al(a, b);
        c.view = this;
        this.wa ? c.init(this) : this.o().g(this, "initialized", function() {
            c.init(this)
        });
        this.Rb[a] = c;
        return this
    ...
    z.e.Lg = function() {
        !this.Bc && this.J.Gf && (this.Bc = this.tn(), z.cf(this.Bc, this.h), this.o().g(this.Bc, "click", this.jh))
    };
    z.e.C = function() {
        z.bl.v.C.call(this);
        this.Lg();
    ...
    z.e.jh = function() {
        if (!1 !== this.dispatchEvent("beforeloadnext") && !this.Ko()) return this.Ku(!0), this.promise = this.source().done((0, z.q)(this.eT, this)).always((0, z.q)(z.Ba(this.Ku, !1), this))
    };
    z.e.Ko = function() {
    ...
    z.e.Ku = function(a) {
        this.Bc && (this.Bc.innerHTML = a ? '\x3ci class\x3d"spinner-gray"\x3e\x3c/i\x3e 鍔犺浇涓�' : "鏇村", z.W.enable(this.Bc, "loading", a))
    };
    var fl = {
        s: function(a, b, c) {
    ...
    Zk("activeSource", {
        ...
        init: function(a) {
            ...
            this.o().g(this.button, "click", function() {
    ...
    Zk("autoload", {
        ...
        enable: function() {
            this.o().ya(this, "nearbottom", function() {
                this.view.jh()
            })
        }
    });
    ...
    Zk("expandLimit", {
        ...
        init: function(a) {
            z.T.Fb() || this.o().g(a, "beforeloadnext", function() {
                var a = new z.Wk;
                a.bd("expand");
                a.show();
                return !1
    ...
    var ql;
    z.x(jl, z.G);
    var kl = [27, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 19],
        ll = "color date datetime datetime-local email month number password search tel text time url week".split(" ");
    z.e = jl.prototype;
    z.e.NU = function(a, b) {
    ...
    z.e.lf = function(a) {
        ...
        if (b)
            if ("keydown" == a.type && sl(a)) this.dH = !1;
            else {
                b = z.mj(a.keyCode);
                c = b & 255 | ((a.shiftKey ? 1 : 0) | (a.ctrlKey ? 2 : 0) | (a.altKey ? 4 : 0) | (a.metaKey ? 8 : 0)) << 8;
                if (!this.Mn[c] || 1500 <= (0, z.I)() - this.jt) this.Mn = this.Dm, this.jt = (0, z.I)();
    ...
    z.x(z.Bl, yl);
    z.Mb(z.Bl.prototype.defaults = {
        tV: 200,
        offsetTop: 0
    }, yl.prototype.defaults);
    z.e = z.Bl.prototype;
    z.e.Ph = function() {
        z.Db(Cl(this), function(a, b) {
    ...
    Zk("shortcut", {
        ...
        init: function(a) {
            a.gb().length && (this.ap = new z.Bl(this.options), this.ap.w(a.m()), this.o().g(this.ap, "action", function(b) {
